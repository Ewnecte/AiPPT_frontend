...
import type { PPTShapeElement, ShapeText } from '@ppt/types/slides'
import type { ContextmenuItem } from '@ppt/components/Contextmenu/types'
import useElementOutline from '@ppt/views/components/element/hooks/useElementOutline'
import useElementShadow from '@ppt/views/components/element/hooks/useElementShadow'
import useElementFlip from '@ppt/views/components/element/hooks/useElementFlip'
import useElementFill from '@ppt/views/components/element/hooks/useElementFill'
import useHistorySnapshot from '@ppt/hooks/useHistorySnapshot'

import GradientDefs from './GradientDefs.vue'
import PatternDefs from './PatternDefs.vue'
import ProsemirrorEditor from '@ppt/views/components/element/ProsemirrorEditor.vue'
