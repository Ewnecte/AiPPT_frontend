...
import { isActiveOfParentNodeType, findNodesWithSameMark, getTextAttrs, autoSelectAll, addMark, markActive, getFontsize } from '@ppt/utils/prosemirror/utils'
...
import type { TextFormatPainterKeys } from '@ppt/types/edit'
