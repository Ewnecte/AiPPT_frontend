...
import useAIPPT from '@ppt/hooks/useAIPPT'
import useSlideHandler from '@ppt/hooks/useSlideHandler'
import type { AIPPTSlide } from '@ppt/types/AIPPT'
import type { Slide, SlideTheme } from '@ppt/types/slides'
import message from '@ppt/utils/message'
import { decrypt } from '@ppt/utils/crypto'
...
import FullscreenSpin from '@ppt/components/FullscreenSpin.vue'
import OutlineEditor from '@ppt/components/OutlineEditor.vue'
