...
import type { ContextmenuItem } from '@ppt/components/Contextmenu/types'
...
import ImageElement from '@ppt/views/components/element/ImageElement/index.vue'
import TextElement from '@ppt/views/components/element/TextElement/index.vue'
import ShapeElement from '@ppt/views/components/element/ShapeElement/index.vue'
import LineElement from '@ppt/views/components/element/LineElement/index.vue'
import ChartElement from '@ppt/views/components/element/ChartElement/index.vue'
import TableElement from '@ppt/views/components/element/TableElement/index.vue'
import LatexElement from '@ppt/views/components/element/LatexElement/index.vue'
import VideoElement from '@ppt/views/components/element/VideoElement/index.vue'
import AudioElement from '@ppt/views/components/element/AudioElement/index.vue'
