...
import type { LineStyleType, PPTElementOutline, PPTShapeElement, PPTTableElement } from '@ppt/types/slides'
import useHistorySnapshot from '@ppt/hooks/useHistorySnapshot'

import SVGLine from '@ppt/views/Editor/Toolbar/common/SVGLine.vue'
