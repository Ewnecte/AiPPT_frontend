...
import type { PPTElement, PPTShapeElement } from '@ppt/types/slides'
import type { AlignmentLineProps, CreateCustomShapeData } from '@ppt/types/edit'
import { injectKeySlideScale } from '@ppt/types/injectKey'
