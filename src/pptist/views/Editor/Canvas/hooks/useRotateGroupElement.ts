...
import type { PPTElement, PPTLineElement } from '@ppt/types/slides'
import useHistorySnapshot from '@ppt/hooks/useHistorySnapshot'
import { canRotateGroupElements, getGroupElementCenter, normalizeAngle, rotateLineElement, rotateRectLikeElement } from '@ppt/utils/element'
