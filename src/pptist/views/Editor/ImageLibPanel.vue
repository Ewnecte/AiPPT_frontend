...
import { useMainStore } from '@ppt/store/main'
...
import MoveablePanel from '@ppt/components/MoveablePanel.vue'
import ImageWaterfallViewer from '@ppt/components/ImageWaterfallViewer.vue'
