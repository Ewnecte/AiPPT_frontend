...
import type { 
  ...
  LineStyleType,
} from '@ppt/types/slides'
import { PRESET_THEMES } from '@ppt/configs/theme'
import { FONTS } from '@ppt/configs/font'
import useHistorySnapshot from '@ppt/hooks/useHistorySnapshot'
import useSlideTheme from '@ppt/hooks/useSlideTheme'
import { getImageDataURL } from '@ppt/utils/image'
import { toFixed } from '@ppt/utils/common'
...
import ColorListButton from '@ppt/components/ColorListButton.vue'
