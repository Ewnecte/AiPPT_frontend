...
import type { Broken2LineDirection, LinePoint, LineStyleType, PPTLineElement } from '@ppt/types/slides'
import useHistorySnapshot from '@ppt/hooks/useHistorySnapshot'

import ElementShadow from '../common/ElementShadow.vue'
import SVGLine from '../common/SVGLine.vue'
import LinePointMarker from '@ppt/views/components/element/LineElement/LinePointMarker.vue'
