...
import type { PPTImageElement, SlideBackground } from '@ppt/types/slides'
import { CLIPPATHS } from '@ppt/configs/imageClip'
import useHistorySnapshot from '@ppt/hooks/useHistorySnapshot'
import useImageHandler from '@ppt/hooks/useImageHandler'
