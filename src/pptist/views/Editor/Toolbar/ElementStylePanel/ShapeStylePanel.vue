...
import type { GradientType, PPTShapeElement, Gradient, ShapeText, TextInset } from '@ppt/types/slides'
import { type ShapePoolItem, SHAPE_LIST, SHAPE_PATH_FORMULAS } from '@ppt/configs/shapes'
...
import useShapeFormatPainter from '@ppt/hooks/useShapeFormatPainter'
...
import ShapeItemThumbnail from '@ppt/views/Editor/CanvasTool/ShapeItemThumbnail.vue'
...
import Slider from '@ppt/components/Slider.vue'
...
import GradientBar from '@ppt/components/GradientBar.vue'
import FileInput from '@ppt/components/FileInput.vue'
