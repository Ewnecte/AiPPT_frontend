...
import { ElementTypes, type PPTElement } from '@ppt/types/slides'

import BaseImageElement from '@ppt/views/components/element/ImageElement/BaseImageElement.vue'
import BaseTextElement from '@ppt/views/components/element/TextElement/BaseTextElement.vue'
import BaseShapeElement from '@ppt/views/components/element/ShapeElement/BaseShapeElement.vue'
import BaseLineElement from '@ppt/views/components/element/LineElement/BaseLineElement.vue'
import BaseChartElement from '@ppt/views/components/element/ChartElement/BaseChartElement.vue'
import BaseTableElement from '@ppt/views/components/element/TableElement/BaseTableElement.vue'
import BaseLatexElement from '@ppt/views/components/element/LatexElement/BaseLatexElement.vue'
import ScreenVideoElement from '@ppt/views/components/element/VideoElement/ScreenVideoElement.vue'
import ScreenAudioElement from '@ppt/views/components/element/AudioElement/ScreenAudioElement.vue'
