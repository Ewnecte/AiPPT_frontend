...
import type { PPTElement } from '@ppt/types/slides'
import type { AlignmentLineProps } from '@ppt/types/edit'
import type { Mode } from '@ppt/types/mobile'
import useSlideBackgroundStyle from '@ppt/hooks/useSlideBackgroundStyle'
import useDragElement from '@ppt/views/Editor/Canvas/hooks/useDragElement'
import useScaleElement from '@ppt/views/Editor/Canvas/hooks/useScaleElement'
import useRotateElement from '@ppt/views/Editor/Canvas/hooks/useRotateElement'

import AlignmentLine from '@ppt/views/Editor/Canvas/AlignmentLine.vue'
