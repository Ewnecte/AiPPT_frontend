...
import type { PPTElement, TableCell } from '@ppt/types/slides'
import { ElementAlignCommands, ElementOrderCommands } from '@ppt/types/edit'
...
import Tabs from '@ppt/components/Tabs.vue'
