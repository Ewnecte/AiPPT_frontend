...
import type { PPTElement, PPTLineElement, PPTChartElement, PPTVideoElement, PPTAudioElement } from '@ppt/types/slides'
import useCommonOperate from '@ppt/views/Editor/Canvas/hooks/useCommonOperate'
import type { OperateResizeHandlers } from '@ppt/types/edit'

import BorderLine from '@ppt/views/Editor/Canvas/Operate/BorderLine.vue'
import ResizeHandler from '@ppt/views/Editor/Canvas/Operate/ResizeHandler.vue'
import RotateHandler from '@ppt/views/Editor/Canvas/Operate/RotateHandler.vue'
